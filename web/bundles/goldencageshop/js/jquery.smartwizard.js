    ...
    $.fn.smartWizard = function(action) {
        ...
        return this.each(function(){
                ...
                function SetupStep(curStep,selStep,stepIdx){
				   ...
				   $(curStep, obj).parent().prev().find("a").css("background-position","right -68px");
				   
				   if (steps.length == stepIdx + 2) $(curStep, obj).css("background-position","right -300px");
				   	else $(curStep, obj).css("background-position","right -66px");
                   $(curStep, obj).addClass("done");
                   
                   $(selStep, obj).removeClass("disabled");
                   $(selStep, obj).removeClass("done");
                   $(selStep, obj).addClass("selected");
				   $(selStep, obj).css("background-position","right -2px");
				   $(selStep, obj).parent().prev().find("a").css("background-position","right -201px");
				   if (steps.length == (stepIdx + 1)) { $(selStep, obj).css("background-position","right -300px"); }
